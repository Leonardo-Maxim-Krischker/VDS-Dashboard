...
p1 <- plot_ly(sd, x = ~Region, 
        ...
        stroke = I("white"),
        type = "histogram",
        # FIX: Explicitly define what the tooltip shows
        # %{x} = Region Name, %{y} = The calculated Count
        # <extra></extra> hides the annoying "trace 0" label
...
p3 <- plot_ly(sd, x = ~Year, y = ~Price_USD, 
        ...
        # FIX: Even though we pass 'Price_USD' as y, the transform changes it to 'count'.
        # %{y} in the tooltip will now correctly show the Count, not the Price.
